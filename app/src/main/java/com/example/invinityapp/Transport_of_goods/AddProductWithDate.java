...
public class AddProductWithDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_with_date);
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(AddProductWithDate.this)
                        .setTitle("مسح !")
    ...
    public void createDilog(final int type){
        ...
        final String beforePik =  year.getValue() + "-" + mont.getValue() + "-" + day.getValue();
        ...
        pikdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View h) {
                ...
                if(quntity.getText().toString().isEmpty() || quntity.getText().toString().compareTo("0") == 0){
                    ...
                    msg.setText("الكمية غير صالحة");
                    msg.setVisibility(View.VISIBLE);

                }else if(beforePik.compareTo(d) == 0 && CanEmpty == false){

                    msg.setText("الرجاء اختيار تاريخ صلاحية صالح");
                    msg.setVisibility(View.VISIBLE);
                }else{
    ...
    public void addItem(View view){
        ...
        if (data.size() == 0) {
            ...
            Toast.makeText(getApplicationContext(), "الرجاء ادخال كمية واحدة على الاقل", Toast.LENGTH_SHORT).show();
            ...
            if (ifInsert) {
                ...
                Intent intent = new Intent(AddProductWithDate.this, ScanProduct.class);
                startActivity(intent);
                AddProductWithDate.this.finish();
