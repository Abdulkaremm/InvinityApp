...
public class ProductHaveDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_have_date);
        ...
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                AlertDialog dialog = new AlertDialog.Builder(ProductHaveDate.this)
                        .setTitle("مسح !")
        ...
        ip = dv.getString(8);
            ...
            if (data.size() == 0) {
                ...
                if (ifInsert) {
                    ...
                    Intent intent = new Intent(ProductHaveDate.this, QuickAdd.class);
                    startActivity(intent);
                    ProductHaveDate.this.finish();
                } else {
